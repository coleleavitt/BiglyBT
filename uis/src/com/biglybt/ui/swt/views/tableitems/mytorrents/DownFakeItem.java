...
/** Fake downloaded bytes column
 *
 * Shows getTotalDataBytesReceivedFake() value formatted as human-readable size.
 */
	...
	public void refresh(TableCell cell) {
		...
		if (dm != null) {
			...
			if (stats instanceof DownloadManagerStatsImpl) {
				value = ((DownloadManagerStatsImpl) stats).getTotalDataBytesReceivedFake();
			}
		}
